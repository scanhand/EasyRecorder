...
namespace ESR.UI
{
    ...
    public partial class RecorderItemView : UserControl
    {
        ...
        public ESRRecorderItemConfigManager RecorderItemConfigManager
        {
            get
            {
        ...
        {
            IRecorderItem newItem = this.RecorderItemConfigManager.ShowNewConfigWindow(new WaitTimeRecorderItem() { Time = GetNewItemTime() + TimeSpan.FromSeconds(ESRRecorder.MinimumTimeSpan) });
            if (newItem == null)
                return;
        ...
        {
            IRecorderItem newItem = this.RecorderItemConfigManager.ShowNewConfigWindow(new MouseUpDownRecorderItem() { Time = GetNewItemTime() + TimeSpan.FromSeconds(ESRRecorder.MinimumTimeSpan) });
            if (newItem == null)
                return;
        ...
        {
            IRecorderItem newItem = this.RecorderItemConfigManager.ShowNewConfigWindow(new KeyUpDownRecorderItem() { Time = GetNewItemTime() + TimeSpan.FromSeconds(ESRRecorder.MinimumTimeSpan) });
            if (newItem == null)
                return;
        ...
        {
            IRecorderItem newItem = this.RecorderItemConfigManager.ShowNewConfigWindow(new MouseWheelRecorderItem() { Time = GetNewItemTime() + TimeSpan.FromSeconds(ESRRecorder.MinimumTimeSpan) });
            if (newItem == null)
                return;
        ...
        {
            IRecorderItem newItem = this.RecorderItemConfigManager.ShowNewConfigWindow(new MouseClickRecorderItem() { Time = GetNewItemTime() + TimeSpan.FromSeconds(ESRRecorder.MinimumTimeSpan) });
            if (newItem == null)
                return;
        ...
        {
            IRecorderItem newItem = this.RecorderItemConfigManager.ShowNewConfigWindow(new KeyPressRecorderItem() { Time = GetNewItemTime() + TimeSpan.FromSeconds(ESRRecorder.MinimumTimeSpan) });
            if (newItem == null)
                return;
